    ...
    <>
      {error === process.env.NEXT_PUBLIC_ERROR ? (
        ...
        result.map((el, index) => (
          <div
            key={el.player.id}
            className="relative grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4"
          >
            <div className="relative bg-gradient-to-br from-pink-500 to-orange-400 rounded-lg">
