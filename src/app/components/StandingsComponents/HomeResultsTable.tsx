...
export default function HomeResultsTable({
  standings,
}: {
          ...
          {standings.response[0].league.standings[0].map((el) => {
            return (
              <tr key={el.team.id}>
                ...
                <td>
                  <p className="ml-2 flex justify-center">{el.home.played}</p>
                </td>
                <td>
                  <p className="ml-2 flex justify-center">{el.home.win}</p>
                </td>
                <td>
                  <p className="ml-2 flex justify-center">{el.home.draw}</p>
                </td>
                <td>
                  <p className="ml-2 flex justify-center">{el.home.lose}</p>
                </td>
